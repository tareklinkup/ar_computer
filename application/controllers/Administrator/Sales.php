...
class Sales extends CI_Controller {
    ...
    public function serialList(){
        $serialList =   $this->db->query("
            ...
            where ps_brunch_id = ? and ps_status <> 'd'
    ...
    public function addSales(){
        ...
        try{
            ...
            $sales = array(
                ...
                'SaleMaster_ReferenceNo' => $data->sales->referenceNo,
    ...
    public function getSalesRecord(){
        ...
        if(isset($data->mobile) && $data->mobile != "") {
            $clauses .= " and c.Customer_Mobile = '$data->mobile'";
        }
    ...
    //         from tbl_salesmaster sm
    //         left join tbl_customer c on c.Customer_SlNo = sm.SalseCustomer_IDNo
    //         left join tbl_employee e on e.Employee_SlNo = c.Customer_SlNo
    //         left join tbl_brunch br on br.brunch_id = sm.SaleMaster_branchid
    //         where sm.SaleMaster_branchid = '$branchId'
    //         and sm.Status = 'a'
    //         $clauses
