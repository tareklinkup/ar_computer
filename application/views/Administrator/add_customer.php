		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<select class="form-control" v-if="employee.length == 0"></select>
						<v-select v-bind:options="employee" v-model="selectedEmployee" label="display_name" v-if="employee.length > 0" v-on:input="currentEmployee"></v-select>
					</div>
			...
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="checkbox" name="is_supplier" value="is_supplier" v-model="customer.is_supplier">
					</div>
				</div>
				<div class="form-group clearfix">
		...
		methods: {
			...
			saveCustomer(){
				...
				if(this.selectedEmployee == null) {
					alert("Select Marketing Officer");
					return;
				}
			...
			editCustomer(customer){
				...
				this.customer.is_supplier = customer.is_supplier == true ? true : false;

				this.selectedDistrict = {
					District_SlNo: customer.area_ID,
					District_Name: customer.District_Name
				}
				let selectedEmployeeArr = this.employee.filter(item => {
					if(	item.Employee_SlNo == customer.employee_id) {
						return item;
					}
				});
				// console.log(selectedEmployeeArr);
				this.selectedEmployee = selectedEmployeeArr[0];
			...
			resetForm(){
				...
				this.imageUrl = '';
				this.selectedFile = null;
				this.customer.is_supplier = false;
				this.selectedDistrict = "";
