			...
			<form class="form-inline" id="searchForm" @submit.prevent="getSearchResult">
				<div class="form-group">
					...
					<select class="form-control" v-model="searchType" @change="onChangeSearchType">
						...
						<option value="employee">By Marketing</option>
				...
				<div class="form-group" style="display:none;" v-bind:style="{display: searchType == 'mobile' ? '' : 'none'}">
					<label>Mobile</label>
					<input type="text" class="form-control" v-model="mobile" autocomplete="off">
				</div>
				...
				<div class="form-group" style="display:none;" v-bind:style="{display:(searchType == 'quantity' || searchType == 'employee') && products.length > 0 ? '' : 'none'}">
					<label>Product</label>
	...
	new Vue({
		...
		data(){
			return {
				...
				sales: [],
				searchTypesForRecord: ['', 'user', 'customer', 'mobile'],
				searchTypesForDetails: ['quantity', 'category', 'employee'],
				mobile: ''
			}
		},
		watch: {
		...
		methods: {
			...
			getSearchResult(){
				...
				if(this.searchType != 'quantity' && this.searchType != 'employee'){
