...
<?php } elseif ($module == 'Administration') { ?>
	<ul class="nav nav-list">
		...
		<?php if (
			...
			|| array_search("pending_transfer_list", $access) > -1
			...
			<li class="">
				...
				<ul class="submenu">
					...
					<?php if (array_search("pending_transfer_list", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>pending_transfer_list">
								<i class="menu-icon fa fa-caret-right"></i>
					...
					<?php if (array_search("pending_receive_list", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>pending_receive_list">
								<i class="menu-icon fa fa-caret-right"></i>
								<span class="menu-text"> Pending Received</span>
							</a>
							<b class="arrow"></b>
						</li>
					<?php endif; ?>
...
<?php } elseif ($module == 'PurchaseModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("pendingPurchase", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>pendingPurchase">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text">Pending Record</span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
...
<?php } elseif ($module == 'AccountsModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("transfer_payment", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>transfer_payment">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Transfer Payment </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (
			...
			<li class="">
				...
				<ul class="submenu">
					...
					<?php if (array_search("transfer_ledger", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>transfer_ledger">
								<i class="menu-icon fa fa-caret-right"></i>
								Transfer Ledger
							</a>
							<b class="arrow"></b>
