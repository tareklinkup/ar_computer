	...
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" id="referencenNo" name="referenceNo" v-model="purchase.referenceNo" style="height:26px;"/>
				</div>
			</div>
							...
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-xs-4" style="display: flex;">
										<input type="text" step="0.01" id="quantity" autocomplete="off" name="quantity" class="form-control" placeholder="Quantity" ref="quantity" v-model="selectedProduct.quantity" v-on:input="productTotal" required />
	...
	new Vue({
		...
		methods:{
			...
			async editFromCart(ind){
				...
				this.selectedProduct.ProductCategory_ID= this.cart[ind].categoryId
				...
				// discount: this.selectedProduct.discount,
				this.selectedProduct.warranty_month = this.cart[ind].warrantyMonth
				this.selectedProduct.display_text = this.products.filter((item) => {
					if(item.Product_SlNo == this.cart[ind].productId) {
						return item;
					}
				})[0].display_text;
			...
			getPurchase(){
				axios.post('/get_purchases', {purchaseId: this.purchase.purchaseId}).then(res => {
					...
					this.purchase.referenceNo = purchase.PurchaseMaster_ReferenceNo;
