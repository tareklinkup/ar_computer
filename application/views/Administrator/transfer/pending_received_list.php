                ...
                <table class="table table-bordered">
                    ...
                    <tbody style="display:none;" v-bind:style="{display: transfers.length > 0 ? '' : 'none'}">
                        <tr v-for="(transfer, sl) in transfers">
                            ...
                            <td>{{ transfer.note }}</td>
                            <td>
                                <a href="" title="Approve Transfer" @click.prevent="approveTransfer(transfer)"><i class="fa fa-check"></i></a>
    ...
    new Vue({
        ...
        methods: {
            ...
            getTransfers(){
                ...
                axios.post('/get_pending_receives', this.filter).then(res => {
            ...
            approveTransfer(transfer){
				...
				axios.post('/approve_transfer', transfer)
				.then(res => {
					let r = res.data;
					alert(r.message);
					if(r.success){
