            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong v-if="sales.SaleMaster_ReferenceNo">Reference No.:</strong> {{ sales.SaleMaster_ReferenceNo }}<br v-if="sales.SaleMaster_ReferenceNo">
                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    <td>{{ sl + 1 }}</td>
                                    <td style="text-align:left">{{ product.Product_Name }} <br>
                                        S/N(<span  v-for="serial in product.serial ">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <strong>Note: </strong>
                        <p style="white-space: pre-line">{{ currentBranch.invoice_note }}</p>
                    </div>
                </div>
            </div>
        </div>
