            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong v-if="purchase.PurchaseMaster_ReferenceNo">Reference No.:</strong> {{ purchase.PurchaseMaster_ReferenceNo }}<br v-if="purchase.PurchaseMaster_ReferenceNo">
                        ...
                        <table _a584de>
                            <thead>
                                <tr>
                                    ...
                                    <td>Unit</td>
                                    <td>Unit Price</td>
                                    <td style="width:15%">Warranty (Month)</td>
                                    <td>Total</td>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td>{{ product.Product_Name }} <br>
                                        S/N(<span  v-for="(Serial, ind) in product.serial">
